...
terms: ["register","integration","astro","config","content","collection","list","option","must","everything","else","default","such","base","path","maps","slug","import","defineconfig","hevask","hevmind","export","integrations","collections","docs","name","basepath","prefix","configuration","reference"]
...
Register the integration in the Astro config, where the content collection list is the one option you must set and everything else has a default such as the base path that maps slug to URL.
