...
terms: ["render","overlay","component","once","somewhere","global","like","base","layout","element","opener","attribute","opens","palette","keyboard","shortcut","bound","automatically","keyword","search","works","point","server","layouts","astro","import","searchoverlay","hevmind","components","button","type","data","open","slot","press"]
