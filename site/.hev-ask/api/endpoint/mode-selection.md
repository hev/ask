...
terms: ["mode","selection","endpoint","decides","empty","query","returns","keyword","json","explicit","request","agentic","without","plus","warning","otherwise","streams","answer","there","unavailable","error","path","missing","simply","downgrades","results","overlay","branches","response","content","type","handle","both","shapes","model","stream","says","reader","still","gets"]
