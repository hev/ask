...
anchor: "vitepress"
terms: ["vitepress","bundle","assets","public","directory","register","overlay","theme","enhance","hook","mounting","digest","path","optional","endpoint","environment","variable","index","import","defaulttheme","mounthevask","hevmind","export","default","extends","enhanceapp","typeof","window","undefined","meta","vite","viteaskendpoint"]
...
For VitePress, bundle the assets into the public directory and register the overlay in your theme's enhance hook, mounting it with the digest path and an optional endpoint from an environment variable.
