...
anchor: "props"
terms: ["props","prop","type","default","description","endpoint","string","overlay","posts","queries","must","match","integration","option","placeholder","search","docs","text","input","searchoverlay","debounce","number","milliseconds","after","typing","stops","before","keyword","query","sent"]
...
Props Prop Type Default Description endpoint string '/api/ask' Endpoint the overlay posts queries to. Must match the integration's endpoint option. placeholder string 'Search the docs…' Placeholder text for the input....
