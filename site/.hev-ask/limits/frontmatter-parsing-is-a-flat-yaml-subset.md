...
terms: ["frontmatter","parsing","flat","yaml","subset","offline","build","parses","small","splitter","rather","full","parser","handling","common","docs","schema","string","number","fields","nested","structures","affects","only","reading","files","disk","astro","runtime","index","uses","collection","honors","real","getcollection","handles","aren","supported","time"]
