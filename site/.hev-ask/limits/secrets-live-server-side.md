...
terms: ["secrets","live","server","side","agentic","path","needs","configured","provider","environment","runs","endpoint","never","exposed","browser","present","runtime","serves","keyword","results","search","degrades","rather","breaking","anthropic","openai","openrouter","anthropicapikey","default","openaiapikey","openrouterapikey","option","doesn","break"]
