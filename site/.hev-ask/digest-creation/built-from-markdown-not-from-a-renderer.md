...
terms: ["built","markdown","renderer","build","never","imports","framework","reads","files","chunks","headings","derives","anchors","code","writes","tree","same","artifact","comes","whether","astro","docusaurus","vitepress","mkdocs","nothing","renders","pages","differs","host","only","runs","during","present","step","everywhere","else","while","wiring","overlay","site"]
