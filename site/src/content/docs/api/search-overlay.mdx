...
If the server has no provider [API key](/docs/api/configuration#choosing-a-provider), asking
...
the Astro route does, holds the provider [API key](/docs/api/configuration#choosing-a-provider) server-side, and reads
