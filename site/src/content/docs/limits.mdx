---
title: "Limits"
description: "The hard boundaries of hev ask: corpus scope, recall ceiling, single-call digest build, frontmatter parsing, latency, and adapter requirements — what it deliberately does not do."
group: "Overview"
order: 4
---
